            ...
            <ul className="flex mt-4 mb-1 space-x-4">
              <li>
                <a
                  ...
                  href="https://twitter.com/@chatsappai"
                  aria-label="Twitter"
                  target="_blank"
                >
                  <svg
            ...
            <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://www.funfun.tools/?via=chatsappai"
                    target="_blank"
                  >
                    AI Tool Directory
                  </a>
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://www.funfun.ai/?via=chatsappai"
                    target="_blank"
                  >
                    AI Characters
                  </a>
            ...
            <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                {/* <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://chatsappai.com/help"
                    target="_blank"
                  >
                    Help Center
                  </a>
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://www.chatsappai.com/blog"
                    target="_blank"
                  >
                    Blog
                  </a>
            ...
            <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://chatsappai.getrewardful.com/"
                    target="_blank"
                  >
                    Affiliates
                  </a>
