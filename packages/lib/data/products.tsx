...
const items: Product[] = [
  ...
  },
  {
    ...
    description:
      'Cree hermosos formularios impulsados por IA que hablen de forma natural, hagan/respondan preguntas y capten a los usuarios en cualquier punto de contacto.',
    metadata: {
      title: 'Formulario IA - Cree formularios con GPT en minutos | ChatsappAI',
    },
    logo: '/images/logo.png',
    cta: {
      label: 'Get Started for Free',
