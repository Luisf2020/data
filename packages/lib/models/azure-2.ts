...
export default class AzureOpenAITwo {
  ...
  async call({
    ...
    this.portkey = new Portkey({
      ...
      azureResourceName: "voice-models-east-us2",
      azureDeploymentId: otherProps.model,
      azureApiVersion: "2024-12-01-preview",
      Authorization: `Bearer ${process.env.AZURE_OPENAI_API_KEY2}`,
      config: {
        cache: {
          mode: "semantic",
          max_age: 60000
    ...
    // Crear span principal con metadata detallada
