...
ALTER TYPE "AgentModelName" ADD VALUE 'gpt_o1_mini';
ALTER TYPE "AgentModelName" ADD VALUE 'gpt_o1';
ALTER TYPE "AgentModelName" ADD VALUE 'deepseek_r1';
ALTER TYPE "AgentModelName" ADD VALUE 'deepseek_v3';

-- AlterTable
ALTER TABLE "agents" ADD COLUMN     "conversational_mode_prompt" TEXT,
ADD COLUMN     "time_between_messages" INTEGER DEFAULT 0,
ADD COLUMN     "use_conversational_mode" BOOLEAN DEFAULT false;
