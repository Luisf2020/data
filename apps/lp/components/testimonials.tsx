  ...
  const testimonials02 = [
    {
      ...
      content:
        'Agregar un Agente de IA personalizado en nuestro sitio web fue increíblemente fácil. El chatbot ha mejorado significativamente la participación del cliente y la disponibilidad del soporte.',
    },
    ...testimonials01,
    // {
        ...
        <div className="px-4 mx-auto max-w-6xl sm:px-6">
          <div className="pb-12 mx-auto max-w-3xl text-center md:pb-20">
            <h2 className="text-3xl font-bold font-bricolage-grotesque md:text-4xl text-zinc-200">
              Amado por miles de empresas de todo el mundo
            </h2>
          </div>
        </div>
