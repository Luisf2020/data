[ChatsappAI](http://chatsappai.com) is powered by large language models (LLM) like OpenAI’s ChatGPT.
As powerful as LLMs are, they can sometimes produce inaccurate or out-of-scope answers. This is called “hallucination”.

[ChatsappAI](http://chatsappai.com) provides multiple mechanisms/features to decrease hallucination.
