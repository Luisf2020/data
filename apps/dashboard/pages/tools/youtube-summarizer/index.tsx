  ...
  return (
    <>
      ...
      <Stack sx={{ width: '100vw', minHeight: '100vh' }}>
        <TopBar href="https://www.chatsappai.com/?utm_source=landing_page&utm_medium=tool&utm_campaign=youtube_summarizer" />
            ...
            >
              <Stack spacing={2} sx={{ width: '100%', alignItems: 'center' }}>
                <Stack sx={{ width: '100%' }} spacing={1}>
                  ...
                  />
                  <a
                    href="https://www.chatsappai.com/?utm_source=landing_page&utm_medium=tool&utm_campaign=youtube_summarizer"
                    target="_blank"
                    style={{
                      textDecoration: 'none',
                      marginLeft: 'auto',
