...
import AgentToolsGlobalTab from '@app/components/AgentToolsGlobalTab';
        ...
        {router.query.tab === 'chat' && (
          ...
          >
                          ...
                          >
                            <Stack gap={1}>
                              ...
                              {tool.type === 'lead_capture' && (
                                ...
                                >
                                  habilitado solo en widgets estándar/burbuja
                                </Alert>
                              )}
            ...
            <editApiToolModal.component
              ...
              description="Permite que tu Agente llame a un punto final HTTP."
              dialogProps={{
                sx: {
                  maxWidth: 'md',
                  height: 'auto',
...

        {
          <>
            ...
            {router.query.tab === 'tools' && (
              ...
              >
                <AgentToolsGlobalTab agentId={router.query.agentId as string} />
              </Box>
            )}
          </>
        }
