  ...
  return (
    ...
    >
      ...
      <Alert
        ...
        sx={{ mb: 2 }}
      >
        Los contactos de ChatsappAI son un CRM de vanguardia impulsado por IA.
        Aquí puedes ver todos los leads, clientes y contactos que has recopilado
        de tus Agentes o Formularios.
      </Alert>
