        ...
        >
          ...
          />
            ...
            <p className="max-w-md mx-auto mt-6 text-lg tracking-tight text-gray-200 sm:mx-0 sm:max-w-lg">
              With our{' '}
              <strong className="text-violet-300">plataforma sin código</strong>
              , puedes crear un{' '}
              <strong className="text-violet-300">
                chatbot de IA personalizado
              </strong>{' '}
              entrenado con tus datos en segundos. Simplifica el soporte al
              cliente, integra a nuevos miembros del equipo, ¡y mucho más!
