                ...
                onChange={pDebounce((e) => {
                  try {
                    if (name.includes('queryParameters')) {
                      ...
                      searchParams[index] = `${e.target.value}=${valueInUrl || ''
                        }`;
                ...
                <Accordion sx={{ ml: 1 }}>
                  <AccordionSummary>
                    <Typography
                      ...
                      color="primary"
                      startDecorator={
                        <GrUserSettings fontSize="sm" color="primary" />
                      }
                    >
                      Advanced
                    </Typography>
                  ...
                  <AccordionDetails>
                    <Stack gap={2}>
                      ...
                      <Input
                        control={methods.control}
                        label="Describe el uso de tu clave para una mejor inferencia de IA :"
    ...
    <Stack>
      ...
      <Stack gap={2}>
        ...
        <Alert color="warning" startDecorator={<InfoRoundedIcon />}>
          <Stack>
            <p>
              La descripción es muy importante, esto es lo que el Agente usará
              para decidir cuándo usarlo y qué hacer.
            </p>
            <p>{`Por ejemplo, para una herramienta que obtiene el clima actual de una ciudad dada: "Útil para obtener el clima actual en una ciudad dada." es mejor que "API del clima"`}</p>
          </Stack>
        </Alert>
        ...
        <FormControl>
          ...
          />
          <FormHelperText>
            {`Cuando está habilitado, se requiere la aprobación de un administrador para proceder con la acción`}
          </FormHelperText>
        </FormControl>
        {/* </Card> */}
          ...
          <Stack gap={1}>
            <Card>
              <Stack gap={2} direction="row">
                <Stack>
                  <Typography level="body-md">Imagen Aleatoria de Gato</Typography>
                  <Typography level="body-sm">
                    Pide a tu agente que obtenga una imagen aleatoria de un gato de thecatapi.com
                  </Typography>
                </Stack>
                <Button
                  size="sm"
                  ...
                  onClick={() => {
                    methods.setValue(
                      `${prefix}config`,
                      {
                        name: 'Imagen Aleatoria de Gato',
                        description: 'Útil para obtener una imagen aleatoria de un gato',
            ...
            <Card>
              <Stack gap={2} direction="row">
                <Stack>
                  <Typography level="body-md">Imagen Aleatoria de Gato</Typography>
                  <Typography level="body-sm">
                    Pide a tu agente que obtenga una imagen aleatoria de
                    thecatapi.com
                  </Typography>
                </Stack>
                <Button
