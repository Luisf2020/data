  ...
  const submitInvite = async (values: OrganizationInviteSchema) => {
    try {
      if (
        ...
        alert(
          'Has alcanzado el número máximo de asientos para tu plan. Por favor, contacta a support@chatsappai.com para actualizar tu plan.'
        );
        return;
      }
      ...
      if (
        ...
        toast.error(
          'No se puede enviar la invitación, por favor contacta a support@chatsappai.com si es persistente.',
          {
            duration: 5000,
          }
        );
