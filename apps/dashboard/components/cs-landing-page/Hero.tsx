            ...
            <div className="flex flex-col mt-4 space-y-4">
              <div className="inline-flex items-center space-x-2">
                ...
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                  IA segura entrenada con tus datos
                </p>
              </div>
              {/* <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
              ...
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                  Sin alucinaciones o respuestas engañosas
                </p>
              </div>
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                  Transferencia humana sin problemas
                </p>
              </div>
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                  Conectar y usar en minutos.
                </p>
              </div>
            </div>
            ...
            >
              <Stack gap={1}>
                ...
                <Typography textColor="text.secondary">
                  <b>+10K</b> empresas han construido con éxito <br></br>su
                  agente AI personalizado con ChatsappAI
                </Typography>
              </Stack>
            </Box>
