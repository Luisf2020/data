...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'apify-image-uploads-prod.s3.us-east-1.amazonaws.com'
      },
      {
        protocol: 'https',
        hostname: 'apify-image-uploads-prod.s3.amazonaws.com'
      }
    ],
  },
    ...
    return [
      ...
      },
      {
        ...
        has: [
          {
            type: 'host',
            value: 'dashboard.chatsappai.com',
          },
        ],
      },
      {
      ...
      beforeFiles: [
        ...
        // },
        {
          ...
          has: [
            {
              type: 'host',
              value: 'api.dashboard.chatsappai.com',
            },
          ],
        },
        {
      ...
      return {
        ...
        async entry(...args) {
          ...
          return {
            ...
            'buffer-worker': path.resolve(
              process.cwd(),
              'workers/buffer-worker.ts'
            ),
          };
        },
      };
